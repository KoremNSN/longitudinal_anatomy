...
```{r}
Model_LA_long <- lmer(Left.Amygdala ~ 0 + Clinical_Trajectory * time + Age + Gender + EstimatedTotalIntraCranialVol +(1|sub), data = aseg_long_PTSD)

Model_RA_long <- lmer(Right.Amygdala ~ 0 + Clinical_Trajectory * time + Age + Gender + EstimatedTotalIntraCranialVol + (1|sub), data = aseg_long_PTSD)

Model_LH_long <- lmer(Left.Hippocampus ~ 0 + Clinical_Trajectory * time + Age + Gender + EstimatedTotalIntraCranialVol + (1|sub), data = aseg_long_PTSD)

Model_RH_long <- lmer(Right.Hippocampus ~ 0 + Clinical_Trajectory * time + Age + Gender + EstimatedTotalIntraCranialVol + (1|sub), data = aseg_long_PTSD)
...
```{r}
Model_LA_ln_long <- lmer(left_Lateral.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + left_Whole_amygdala + (1|sub), data = amygdala_PTSD)

Model_LA_bn_long <- lmer(left_Basal.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + left_Whole_amygdala + (1|sub), data = amygdala_PTSD)

Model_LA_cn_long <- lmer(left_Central.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + left_Whole_amygdala + (1|sub), data = amygdala_PTSD)

Model_RA_ln_long <- lmer(right_Lateral.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + right_Whole_amygdala + (1|sub), data = amygdala_PTSD)

Model_RA_bn_long <- lmer(right_Basal.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + right_Whole_amygdala + (1|sub), data = amygdala_PTSD)

Model_RA_cn_long <- lmer(right_Central.nucleus ~ 0 + Clinical_Trajectory * time + Age + Gender + right_Whole_amygdala + (1|sub), data = amygdala_PTSD)
```
